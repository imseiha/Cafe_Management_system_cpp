...
namespace
{
    ...
    void printMatchingReceipts(const std::string &searchText, bool searchDate)
    {
...
void Sale::searchReceiptById()
    {
        ...
        printMatchingReceipts("#" + receiptId, false);
    }
...
void Sale::searchReceiptByOrderId()
    {
        ...
        printMatchingReceipts(orderId, false);
    }
...
void Sale::searchReceiptByDate()
    {
        ...
        std::cin >> date;
        printMatchingReceipts(date, true);
    }
